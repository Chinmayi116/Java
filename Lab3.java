...
System.out.println("2.UPI:"); System.out.println("3.Wallet:");

int choice=sc.nextInt(); PaymentGateway pg=null; switch(choice){
case 1:
System.out.println("Enter Card Number:"); String Cardno=sc.next(); System.out.println("Enter Pin:");
int cpin=sc.nextInt();


pg = new CreditCard(name,Cardno,cpin); break;
case 2:
System.out.println("Enter UPI ID:"); String upi=sc.next(); System.out.println("Enter Pin:"); int upin=sc.nextInt();

pg=new UPI(name,upi,upin); break;
case 3:
System.out.println("Enter Wallet Balance:"); double bal=sc.nextDouble();

pg=new Wallet(name,bal); break;
default:
System.out.println("Invalid choice!!"); System.exit(0);
 
}
//Process payment pg.processPayment();

//static method call PaymentGateway.feedback();
